...
use crate::leftover_format_debug_marker::usecase::{
    LeftoverFormatDebugMarkerPolicy, LeftoverFormatDebugMarkerSummary,
};
use paredit_core_cli::args::OutputFormat;

pub fn print_leftover_format_debug_marker_report(
    summary: &LeftoverFormatDebugMarkerSummary,
    policy: &LeftoverFormatDebugMarkerPolicy,
    output: OutputFormat,
) -> CliResult<()> {
    match output {
        OutputFormat::Text => {
