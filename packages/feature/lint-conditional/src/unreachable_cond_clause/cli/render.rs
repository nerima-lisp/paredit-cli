...
use crate::application::usecase::unreachable_cond_clause_report::{
    UnreachableCondClausePolicy, UnreachableCondClauseSummary,
};
use crate::presentation::cli::OutputFormat;

pub(super) fn print_unreachable_cond_clause_report(
    summary: &UnreachableCondClauseSummary,
    policy: &UnreachableCondClausePolicy,
    output: OutputFormat,
) -> Result<()> {
    match output {
        OutputFormat::Text => {
