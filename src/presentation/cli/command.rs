use super::{
    ...
    last_default_count_report, let_report, lint_report, list_star_to_cons_report,
    literal_place_report, make_hash_table_test_report, make_list_default_element_report,
