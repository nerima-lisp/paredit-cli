use super::{
    ...
    car_nthcdr_report, car_reverse_report, case_nil_key_report, char_case_fold_report,
    char_op_string_report, class_cycle_report, code_char_char_code_report, coerce_to_t_report,
    complexity_report, cond_t_clause_report, cons_to_list_report, constant_if_test_report,
    ...
    format_to_string_report, funcall_lambda_report, function_parameter, gethash_default_report,
    ...
    nested_boolean_report, nested_cxr_report, nested_progn_report, nested_string_case_report,
