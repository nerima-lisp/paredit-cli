...
```sh
nix run github:nerima-lisp/paredit-cli/v1.5.0 -- --help
nix profile install github:nerima-lisp/paredit-cli/v1.5.0
cargo install --git https://github.com/nerima-lisp/paredit-cli --tag v1.5.0 --locked
```
