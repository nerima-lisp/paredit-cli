...
use crate::presentation::cli::nthcdr_small_index_report::args::NthcdrSmallIndexReportArgs;
use crate::presentation::cli::nthcdr_small_index_report::render::print_nthcdr_small_index_report;
use crate::presentation::cli::shared::{expand_input_files, read_input_dialect_and_tree};

pub(in crate::presentation::cli) fn nthcdr_small_index_report(
    args: NthcdrSmallIndexReportArgs,
) -> Result<()> {
