...
```sh
nix run github:nerima-lisp/paredit-cli/v1.6.0 -- --help
nix profile install github:nerima-lisp/paredit-cli/v1.6.0
cargo install --git https://github.com/nerima-lisp/paredit-cli --tag v1.6.0 --locked
```
