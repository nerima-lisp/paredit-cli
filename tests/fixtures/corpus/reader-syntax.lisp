...
(defun |weird name with (parens) and ;semicolons| () :ok)
(defparameter |a| '|b c|)

;;; Vectors, bit vectors, and pathnames.
(defparameter *vector* #(1 2 3))
(defparameter *bits* #*10110)
(defparameter *path* #p"/tmp/corpus.lisp")
...
(defparameter *complex* (list #C(0.0 0.0) #C(1.5 -2.0) #c(1/2 3/4)))
(defparameter *radix* (list #b1011 #o755 #xdeadBEEF #16r1F #2r1010))
(defparameter *array* #2A((1 2 3) (4 5 6)))
(defparameter *struct* #S(paredit-corpus-point :x 1 :y 2))
(defparameter *ratio* (list 1/3 -22/7))
