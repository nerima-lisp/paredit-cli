...
//!
//! The analysis lives in [`crate::domain::subseq_zero_report`], which also backs the
...
use crate::domain::subseq_zero_report::examine;
...
impl LintRule for Rule {
    ...
    fn check(
        ...
        examine(view, context.path(), &mut subseq_form_count, &mut items);
        for item in items {
            let span = item.span;
            let fix = {
