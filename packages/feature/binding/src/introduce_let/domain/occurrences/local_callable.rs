...
use crate::introduce_let::domain::syntax::local_callable_binding_child_shadowed;

pub fn collect_local_callable_binding_spans(
...
pub fn is_span_shadowed_by_local_callable_binding(
    semantic: VerifiedSemanticPolicy<IntroduceLetOperation>,
    binding_form: &ExpressionView,
...
pub fn is_path_shadowed_by_local_callable_binding(
    semantic: VerifiedSemanticPolicy<IntroduceLetOperation>,
    binding_form: &ExpressionView,
