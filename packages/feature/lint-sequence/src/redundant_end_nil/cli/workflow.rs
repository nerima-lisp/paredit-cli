...
use crate::application::usecase::redundant_end_nil_report::{
    RedundantEndNilPolicyOptions, collect_redundant_end_nils, evaluate_redundant_end_nil_policy,
    summarize_redundant_end_nils,
};
use crate::presentation::cli::redundant_end_nil_report::args::RedundantEndNilReportArgs;
use crate::presentation::cli::redundant_end_nil_report::render::print_redundant_end_nil_report;
use crate::presentation::cli::shared::{expand_input_files, read_input_dialect_and_tree};

pub(in crate::presentation::cli) fn redundant_end_nil_report(
    args: RedundantEndNilReportArgs,
) -> Result<()> {
