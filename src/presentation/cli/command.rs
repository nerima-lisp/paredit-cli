...
use super::{
    ...
    butlast_default_count_report, call_cycle_report, call_graph_report, call_report, capabilities,
    car_nthcdr_report, car_reverse_report, case_nil_key_report,
    cerror_missing_continue_format_report, change_summary, char_case_fold_report,
    char_op_string_report, circular_literal_report, class_cycle_report, class_hierarchy_report,
    clone_report, code_char_char_code_report, coerce_to_t_report, cohesion_report,
    commented_repl_transcript_report, complexity_report, cond_t_clause_report, config,
    cons_to_list_report, constant_if_test_report, constant_report, constant_when_test_report,
    context_report, convert_cond_to_if, convert_flet_to_labels, convert_if_to_cond,
    ...
    data_check_report, de_morgan_report, dead_boolean_operand_report, debt_score_report,
    ...
    dependency_report, destructive_literal_report, disabled_test_left_in_report, docstring_report,
    dolist_result_form_references_loop_variable_report,
    dotimes_bound_mutation_has_no_effect_report, double_reverse_report,
    duplicate_boolean_operand_report, duplicate_case_key_report, duplicate_cond_test_report,
    duplicate_defmethod_signature_report, duplicate_keyword_report,
    ...
    empty_test_body_report, eq_char_comparison_report, eq_number_comparison_report,
    ...
    flatten_progn, fold_constants, form_report, format_directive_report,
    format_missing_destination_report, format_newline_report, format_to_string_report,
    funcall_lambda_report, function_parameter, future_promise_never_realized_report,
    generate_accessors, generate_defgeneric, generate_defpackage, generate_defsystem,
    generate_docstring, generate_tests, generic_dispatch_report,
    generic_function_no_methods_report, getf_default_nil_report, gethash_default_report,
    giant_conditional_form_report, handler_bind_handler_returns_bare_value_report,
    ...
    inline_local_function, inline_symbol_macro, introduce_let, keyword_arity_report,
    kill_ring_report, lambda_list_keyword_order_report, last_default_count_report,
    leftover_break_call_report, leftover_format_debug_marker_report, leftover_inspect_call_report,
    leftover_print_debug_report, leftover_step_call_report, leftover_time_benchmark_call_report,
    leftover_trace_call_report, let_report, license_header_report, license_report,
    line_metrics_report, lint_report, list_star_nil_report, list_star_to_cons_report,
    literal_place_report, lock_acquired_not_released_report, loop_clause_order_violation_report,
    ...
    method_qualifier_typo_report, modify_macro_arity_report, multiple_value_list_of_values_report,
    naming_report, narrowing_report, negated_comparison_report, negated_if_report,
    negated_step_delta_report, negated_when_unless_report, nested_boolean_report,
    nested_char_case_report, nested_cxr_report, nested_progn_report, nested_string_case_report,
    nested_unless_report, nested_when_report, nil_comparison_report, nth_constant_index_report,
    ...
    quoted_case_key_report, reachability_report, read_conditional_report, read_time_eval_report,
    readtable_case_report, recursive_lock_reentry_risk_report, redefinition_report,
    ...
    refactor_checkpoint, refactor_step, remove_unused_binding, remove_unused_control, rename,
    rename_control, replace_forms, resolve_report, restart_case_clause_without_report_report,
    restart_report, self_assignment_report, self_comparison_report,
...
pub(super) enum InspectCommand {
    ...
    LoopUnreachableFinallyClause(loop_unreachable_finally_clause_report::args::LoopUnreachableFinallyClauseReportArgs),    /// Report a test disabled in place rather than removed.
