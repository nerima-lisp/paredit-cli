...
use super::{
    ...
    constant_if_test_report, constant_report, constant_when_test_report,
    contains_on_non_associative_report, context_report, convert_cond_to_if, convert_flet_to_labels,
    ...
    dead_boolean_operand_report, debt_score_report, deeply_nested_anonymous_lambda_report,
    def_inside_function_body_report, defclass_required_slot_no_initform_or_initarg_report,
    defclass_slot_shadowing_report, defconstant_non_eql_value_report,
    ...
    go_block_blocking_channel_op_report, go_to_undefined_tag_report,
    handler_bind_handler_returns_bare_value_report, handler_case_no_clauses_report,
    hash_table_iteration_order_assumed_report, hotspot_report, identical_if_branch_report,
    identity_arithmetic_report, if_arity_report, if_not_report, if_to_or_report,
    if_to_unless_report, ignore_errors_wraps_non_error_signal_report, impact_report,
    indentation_report, inline_function, inline_lambda, inline_let, inline_literal_constant,
    inline_local_function, inline_symbol_macro, intern_dynamic_package_target_report,
    introduce_let, introspection_probe_unchecked_report, keyword_arity_report, kill_ring_report,
    lambda_list_keyword_order_report, last_default_count_report, leftover_break_call_report,
    leftover_format_debug_marker_report, leftover_inspect_call_report, leftover_print_debug_report,
    leftover_step_call_report, leftover_time_benchmark_call_report, leftover_trace_call_report,
    let_report, license_header_report, license_report, line_metrics_report, lint_report,
    list_star_nil_report, list_star_to_cons_report, literal_place_report,
    lock_acquired_not_released_report, loop_clause_order_violation_report,
    loop_collect_into_immediately_returned_report, loop_for_across_statically_known_list_report,
    loop_into_accumulator_kind_conflict_report, loop_report,
    loop_unreachable_finally_clause_report, macro_expansion_report, macro_hygiene_report,
    magic_number_report, make_array_default_keyword_report, make_hash_table_test_report,
    ...
    merge_nested_let_star, method_combination_report, method_qualifier_typo_report,
    mixed_float_precision_arithmetic_report, modify_macro_arity_report,
    multiple_value_bind_all_ignored_report, multiple_value_list_of_values_report,
    multiple_value_setq_arity_mismatch_report, naming_report, narrowing_report,
    ...
    package_level_shadowing_report, package_lock_report, parking_op_outside_go_machinery_report,
    parse_integer_default_radix_report, positional_argument_count_exceeds_readability_report,
    ...
    redundant_the_report, refactor, refactor_checkpoint, refactor_step,
    reference_type_operator_mismatch_report, remove_unused_binding, remove_unused_control, rename,
    rename_control, replace_forms, resolve_report, restart_case_clause_without_report_report,
    restart_report, return_from_unmatched_block_report, return_outside_implicit_nil_block_report,
    scheme_begin_single_form_report, scheme_let_star_independent_bindings_report,
    scheme_memq_assq_literal_key_report, scheme_named_let_never_recurs_report,
    self_assignment_report, self_comparison_report, self_recursive_tail_call_report,
    semantic_coverage_report, serial_consistency_report, set_membership_via_linear_scan_report,
    setf_arity_report, setq_non_variable_report, sharp_quoted_lambda_report,
    sign_comparison_report, signal_on_error_condition_returns_silently_report, signature_report,
    similarity_report, single_arg_comparison_report, single_clause_cond_report,
    single_key_nested_path_report, single_operand_arithmetic_report, single_operand_boolean_report,
    single_operand_list_op_report, single_value_bind_report, sleep_in_test_report,
    slot_value_bypasses_accessor_report, source_report, split_let, split_let_star,
    step_zero_report, string_case_fold_report, stringly_typed_dispatch_report, struct_cycle_report,
    structural_diff, structural_patch, subseq_zero_report,
...
pub(super) enum InspectCommand {
    ...
    /// Report a core.async blocking op reached from a go body, which can deplete the fixed go-block thread pool.
    GoBlockBlockingChannelOp(
        go_block_blocking_channel_op_report::args::GoBlockBlockingChannelOpReportArgs,
    ),
    /// Report a core.async parking op inside a go body but behind a boundary the go transform does not rewrite.
    ParkingOpOutsideGoMachinery(
        parking_op_outside_go_machinery_report::args::ParkingOpOutsideGoMachineryReportArgs,
    ),
    /// Report a contains? whose collection is a sequence, or a vector asked about a non-index key, so it can never answer true.
    ContainsOnNonAssociative(
        contains_on_non_associative_report::args::ContainsOnNonAssociativeReportArgs,
    ),
    /// Report an atom/ref/volatile operator applied to a local bound to a different reference constructor.
    ReferenceTypeOperatorMismatch(
        reference_type_operator_mismatch_report::args::ReferenceTypeOperatorMismatchReportArgs,
    ),
}
