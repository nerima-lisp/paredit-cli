...
//!
//! The analysis lives in [`crate::domain::single_operand_arithmetic_report`], which also backs the
...
use crate::domain::single_operand_arithmetic_report::examine_arithmetic;
