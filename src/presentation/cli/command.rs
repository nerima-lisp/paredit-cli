use super::{
    ...
    car_nthcdr_report, car_reverse_report, case_nil_key_report, char_op_string_report,
    class_cycle_report, coerce_to_t_report, complexity_report, cond_t_clause_report,
    ...
    duplicate_export_report, duplicate_lambda_list_keyword_report, duplicate_let_binding_report,
    duplicate_method_report, duplicate_parameter_report, duplicate_report,
    duplicate_setf_place_report, duplicate_slot_report, eliminate_empty_binding_form,
    empty_body_report, empty_let_report, eq_char_comparison_report, eq_number_comparison_report,
    ...
    gethash_default_report, identical_if_branch_report, identity_arithmetic_report,
    if_arity_report, if_not_report, if_to_or_report, impact_report, inline_function, inline_lambda,
    inline_let, inline_literal_constant, inline_local_function, inline_symbol_macro, introduce_let,
    lambda_list_keyword_order_report, let_report, lint_report, list_star_to_cons_report,
    literal_place_report, make_hash_table_test_report, malformed_case_clause_report,
    ...
    merge_nested_let, merge_nested_let_star, modify_macro_arity_report,
    multiple_value_list_of_values_report, naming_report, negated_comparison_report,
    ...
    single_value_bind_report, split_let, split_let_star, struct_cycle_report, subseq_zero_report,
    ...
    unused_nickname_report, unused_package_report, unused_parameter_report, unwrap_call,
    values_list_of_list_report, verbose_negation_report, workspace_report,
};
use clap::Subcommand;
