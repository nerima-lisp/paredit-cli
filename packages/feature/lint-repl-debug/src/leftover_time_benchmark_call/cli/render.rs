...
use crate::leftover_time_benchmark_call::usecase::{
    LeftoverTimeBenchmarkCallPolicy, LeftoverTimeBenchmarkCallSummary,
};
use paredit_core_cli::args::OutputFormat;

pub fn print_leftover_time_benchmark_call_report(
    summary: &LeftoverTimeBenchmarkCallSummary,
    policy: &LeftoverTimeBenchmarkCallPolicy,
    output: OutputFormat,
) -> CliResult<()> {
    match output {
        OutputFormat::Text => {
